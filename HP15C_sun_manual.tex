...
\subparagraph{An AP (\emph{Assumed Position})} is entered in registers \asm{\textbf{8}} and \asm{\textbf{.8}} before any calculations can be peformed.
...
\subparagraph{Every day} has its own parameters that require the \asm{\textbf{A}}-routine to be run each new day.
